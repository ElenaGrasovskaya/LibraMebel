...
export declare const createImageShortcode: ({ inputDirectory, outputDirectory, svgoOptions, rasterOptions, }?: ImageShortCodeOptions) => (src: string, { alt, title, classes }?: ImageAttributes) => Promise<string>;
