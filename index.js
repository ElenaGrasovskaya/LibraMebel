...
document.addEventListener('swiped-left', function(e) {
  ...
  if(element == "viewport lazyloaded")
  plusSlides(1);
 ...
 for (let i = 0; i< slides.length; i++)
  {
    ...
    let newInHTML = inHTML.replaceAll("page"+pageNum,"page"+newPageNum);
  ...
  function change()
  {
    for (let i = 0; i < thumbnails.length; i++)
    {
      thumbnails[i].src=thumbnails[i].src.replaceAll("page"+pageNum,"page"+newPageNum);
    }
